...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
        ...
        UserResponse loginResponse=new UserResponse(userDetails.getId(),jwtCookie.toString(),userDetails.getUsername(), roles);
    ...
    public ResponseEntity<UserResponse> getUserDetails(Authentication authentication){
        ...
        UserResponse loginResponse=new UserResponse(userDetails.getId(),userDetails.getUsername(), roles);
