    ...
    <div className='h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0'>
      ...
      <div className='lg:px-14 sm:px-8 px-4 w-full flex justify-between'>
        ...
        <ul className={`flex sm:gap-10 gap-4 sm:items-center text-slate-800 sm:static absolute left-0 top-[70px] sm:shadow-none shadow-md 
          ${navbarOpen ? "h-fit sm:pb-0 pb-5" : "h-0 overflow-hidden"} transition-all duration-100 sm:h-fit sm:bg-transparent bg-custom-gradient text-white sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}>
          ...
          <li className='font-[500] transition-all duration-150'>
            <Link className="flex items-center space-x-2  py-1.5
                             bg-linear-to-r form-purple-600 to-red-500
